...
<div class="container">
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 border-bottom mb-3">
        <div class="col-md-10">
            <h4 class="text-primary my-2 mr-md-5">Edit Location</h4>
        </div>
    ...
    <form action="{{route('loc.update', $location->id)}}" method="POST">
    @csrf
    @method('put')
        <div class="row justify-content-center mb-3">   
            <Strong><label for="location" class="col-md-2 form-label">Location</label></Strong>
            <div class="col-md-6">
                <input type="text" class="form-control" name="location" value="{{$location->name}}" autocomplete="on">
            </div>
        </div>    
