...
<div class="container">
    ...
    <section class="border-bottom">
        <div class="text-md-start">
            <h4 class="text-primary fw-bold">Location Manager</h4>
        </div>
    </section>
    ...
    <section class="py-1">
        <div class="row  row-cols-1 row-cols-sm-1 row-cols-md-2 my-1">
            <div class="col-lg-6 d-flex justify-content-md-start">
                <a href="{{route('loc.create')}}"><button type="button" class="btn btn-primary">Add New Location</button></a>
            </div>
